...
/*   Updated: 2022/06/14 20:40:21 by yejikim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_left(t_map_info *map_info)
{
	...
	map_info->state.plane_x = curr_plane_x * cos(THETA) \
												+ curr_plane_y * sin(THETA);
	map_info->state.plane_y = curr_plane_y * cos(THETA) \
												- curr_plane_x * sin(THETA);
}
